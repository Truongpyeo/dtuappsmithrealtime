...
### CDN 
```html
<script src="https://cdn.jsdelivr.net/npm/dtuappsmithrealtime@1.1.13/dist/index.umd.js"></script>
```

### Appsmith
Thêm URL sau vào Resource của Appsmith:
```
https://cdn.jsdelivr.net/npm/dtuappsmithrealtime@1.1.13/dist/index.umd.js
```
...
```
https://cdn.jsdelivr.net/npm/dtuappsmithrealtime@1.1.13/dist/index.esm.js
```
